//**********************************************************************
//wanglandau.cpp
//This code implements a  MC Wang-Landau simulation for the 
//Hamiltonean  V(h,b)=-hb[1-(1-\delta)\Theta(hb)] in
//a Barabasi-Alberts network
// July 25, 2011
//R. Vicente
//**********************************************************************
...
{
  printf( "\n");
  printf("USAGE: wanglandau  DELTA ISSUES M DIM SIZE FLAT MINLOGF ");
